# Len(Line-Clone)
<div align="center">
  <img src="./app/img/logo.png" width="150px" alt="Logo">
</div>
...
# Len Documentation
 o> Description
  Len is an Project for managing a Social Media, Developing both server and client of a social media application that allows users to interact with each other through posts, comments, like and follows
...
# Getting Started
 To get started with the Len, follow these steps:
...
# Note
I'm really sorry for the project we made, it still can't support mobile due to time. Maybe the mobile version is still coming soon
